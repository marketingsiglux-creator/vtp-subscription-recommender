                ...
                <div style={styles.ctaRow}>
                  {result.plan === "180-day" ? (
                    <a
                      ...
                      aria-label="Go to VetTechPrep pricing to choose the 180-day plan"
                    >
                      Continue with 180-day
                    </a>
                  ) : (
                    <a
                      href={pricingHref}
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      aria-label="Go to VetTechPrep pricing to choose the 90-day plan"
                    >
                      Continue with 90-day
                    </a>
                  )}
                </div>
